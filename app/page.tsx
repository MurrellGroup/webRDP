...
const METHOD_META: Record<MethodName, { family: string; detail: string; limit: string; citation: string }> = {
  ...
  BootScan: {
    ...
    detail: "RDP5 distance-mode RecScan batch with shared pair/window bootstrap distances and triplet-local source scoring.",
    limit: "The active BSXoverR2 → SEQBOOT2 → FastBootDistIP → GetPltVal2 → MakeScoresBS/ProbCalc distance path is ported; optional UPGMA/NJ relationship modes and desktop golden-corpus validation remain.",
          ...
          <div className="sidebar-scroll">
            ...
            <section className="settings-section controls">
              ...
              <details><summary>Advanced controls</summary><div className="advanced-controls">
                ...
                {options.methods.includes("BootScan") && <details className="parity-controls"><summary>BootScan / RecScan source controls</summary><div>
                  ...
                  <div className="source-fixed-setting"><span>Relationship mode</span><b>Pairwise distances</b><small><code>BSXoverR2 → SEQBOOT2 → FastBootDistIP → GetPltVal2</code>. Pair matrices are shared across every requested concrete triplet.</small></div>
                </div></details>}
