        ...
        <section className="workspace">
          ...
          <div className="workspace-content">
            ...
            {tab === "methods" && <>
              ...
              <div className="fidelity-banner"><strong>Validation state · scientific alpha</strong><p>The active engine now includes multi-signal RDP5 VNP scanning; the full six-track GENECONV fragment queue; the author-source distance-mode BootScan/RecScan batch with shared window pair matrices, seeded SEQBOOT2 replicates and triplet-local binomial scoring; source MAXCHI/CHIMAERA compressed-site profiles; source BURT breakpoint refinement; recursive erase/extract signal disassembly; source-style event merging; all-sequence/all-three-orientation co-recombinant screening; seeded JC/NJ bootstrap tree evidence; the source SiScan 15-category/outgroup/permutation workflow; and the default RDP5 recombinant-identification consensus. Remaining numerical-parity gates include BootScan’s optional UPGMA/NJ relationship modes, the author-source 3Seq batch, standalone SiScan discovery, optional logistic/neural role selectors, exact Clearcut/CheckBSTree behavior, and a broad RDP5 desktop golden regression corpus.</p><span>Detector specification: author-supplied RDP5 VB/native source only.</span></div>
